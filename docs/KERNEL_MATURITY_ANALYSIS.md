...
3. Extend sender identity/badge hardening to registry service-side caller binding and tighten remaining notify endpoint policy surfaces without breaking churn flows.
