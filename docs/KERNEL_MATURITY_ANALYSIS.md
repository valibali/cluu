...
3. Extend WP-M4.1 sender identity/badge hardening to registry/procmgr reply/notify endpoint contracts (remove caller-controlled endpoint routing where practical).
