...
pub fn capture_boot_snapshot() -> Result<BootSnapshot> {
    ...
    Ok(BootSnapshot {
        ...
        view_mgr_token: info.view_mgr_token,
        block_region_token: info.block_region_token,
        device_region_token: info.device_region_token,
        irq_root_token: info.irq_root_token,
