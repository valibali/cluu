    ...
    fn cpu_read(&mut self, addr: u16) -> u8 {
        match addr {
            0x8000..=0xFFFF => {
                ...
                // 76-in-1: group of banks selected by upper bits
                let group = (self.bank as usize >> 4) & 0x07;
                let sub = (self.bank as usize) & 0x0F;
                let bank = group * 16 + sub;
