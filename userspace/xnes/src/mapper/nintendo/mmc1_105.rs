...
/// MMC1 variant SOROM/SIROM (mapper 105).
///
/// Same underlying MMC1 PRG/CHR banking but with:
/// - Different initial register state
/// - Scanline IRQ support (counts down each scanline)
...
impl Mmc1_105 {
    pub fn new(prg: &[u8], chr: &[u8], chr_ram: bool, mirror: u8) -> Self {
        Self {
            ...
            shift: 0,
            shift_count: 0,
            // MMC1-105 starts with different initial control value
            control: 0x00,
            chr0: 0,
            chr1: 0,
            prg_bank: 0,
